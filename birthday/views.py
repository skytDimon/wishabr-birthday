...
register(Wish("tea", u"Кружка чая",
              u"Черный или зеленый, с сахаром или без, с лимоном, а может быть ройбуш-ваниль? — уточняйте заказ в «особых пожеланиях»"))
register(Wish("coffee", u"Кружка кофе",
              u"С молоком, со взбитыми сливками, мороженым, сахаром, корицей:) — укажите в разделе «особых пожеланий»"))
...
register(Wish("cake", u"Кусочек торта",
              u"Небольшой кусок торта Панчо из нежного бисквита, покрытого сочной глазурью или кусок фруктового торта"))
